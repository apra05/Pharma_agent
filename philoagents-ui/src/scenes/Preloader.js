...
export class Preloader extends Scene
{
    ...
    preload ()
    {
        ...
        this.load.atlas("krishna", `characters/krishna/atlas.png${cacheBust}`, `characters/krishna/atlas.json${cacheBust}`); 
        this.load.atlas("buddha", `characters/buddha/atlas.png${cacheBust}`, `characters/buddha/atlas.json${cacheBust}`); 
        this.load.atlas("chanakya", `characters/chanakya/atlas.png${cacheBust}`, `characters/chanakya/atlas.json${cacheBust}`); 
    }
