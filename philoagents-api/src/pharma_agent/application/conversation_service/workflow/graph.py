...
from pharma_agent.application.conversation_service.workflow.edges import (
    should_summarize_conversation,
)
from pharma_agent.application.conversation_service.workflow.nodes import (
    conversation_node,
...
def check_guardrail_condition(state: PhilosopherState):
    if state.get("guardrail_violated", False):
        return "refuse"
    else:
        return "continue"
