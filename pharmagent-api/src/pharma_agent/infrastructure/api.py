...
from pharma_agent.application.conversation_service.reset_conversation import (
...
from pharma_agent.application.evaluation import log_chat_interaction_to_evidently
...
app = FastAPI(
    ...
    description="API for the Pharma Agent chat application.",
    version="1.0.0",
)
...
async def root():
    ...
    <body>
        <h1>🏛️ Pharma Agent API <span class="badge">● Online</span></h1>
        <p>Backend API for the Pharma Agent chat application.</p>
...
async def health():
    ...
    return {"status": "ok", "service": "pharma_agent-api"}
    ...
    try:
        while True:
            ...
            try:
                ...
                context = ""
                try:
                    from pharma_agent.application.conversation_service.generate_response import get_latest_conversation_state
