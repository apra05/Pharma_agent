...
<div class="header">
  <div class="header-left">
    <div>
      ...
      <p>Real-time AI quality metrics for your Pharma Agents</p>
    </div>
  </div>
      ...
      <div class="kpi-label">
        <span class="metric-tooltip">💬 Total Chat Interactions
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it is:</b> The total number of messages your users have sent to any agent since the system started collecting data.</div>
      ...
      <div class="kpi-label">
        <span class="metric-tooltip">😊 Response Sentiment
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it is:</b> A score from -1 to +1 that measures how positive or negative the agent's reply sounds. 0 = neutral, +1 = very positive, -1 = very negative.</div>
            <div class="tt-why"><b>Why it matters:</b> Agents should be thoughtful and respectful, not harsh or cold. We want scores near 0 to +0.6.</div>
      ...
      <div class="kpi-label">
        <span class="metric-tooltip">📏 Avg Response Length
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it is:</b> The average number of characters in the agent's replies. More characters = longer, more detailed answers.</div>
      ...
      <div class="kpi-label">
        <span class="metric-tooltip">🔗 Response Faithfulness
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it measures:</b> Evaluates whether the agent's response is solely supported by the retrieved context (documents retrieved from RAG), or if it contains hallucinated facts not present in the source materials.</div>
            <div class="tt-why"><b>Why use it:</b> Crucial for detecting if the agent is making up claims that aren't in the database.</div>
      ...
      <div class="card-header">
        <div class="metric-tooltip card-title">Response Length Trend
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it shows:</b> How the average length of agent replies changes with each conversation. A sudden drop might mean the model is being cut off. A huge spike could mean it's rambling.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card-header">
        <div class="metric-tooltip card-title">Sentiment Trend (Response vs Query)
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it shows:</b> How upbeat or negative both the user and the agent are, over time. If agent sentiment drops while user is positive, the agent may be acting oddly.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card-header">
        <div class="metric-tooltip card-title">Faithfulness (Anti-Hallucination)
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it shows:</b> Whether the agent stays grounded in real knowledge over time. Declining faithfulness = more hallucinations appearing.</div>
          </div>
        </div>
      </div>
      ...
      <div class="kpi-label">
        <span class="metric-tooltip">🧪 Evaluation Runs
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it is:</b> Total number of agent responses evaluated against a predefined test dataset where we know the correct expected answers.</div>
          </div>
        </span>
      </div>
      ...
      <div class="kpi-label">
        <span class="metric-tooltip">✅ Correctness
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what"><b>What it measures:</b> Evaluates whether the agent's answer matches the factuality and details of the reference (expected) answer.</div>
      ...
      <div class="card-header">
        <div class="metric-tooltip card-title">Correctness Over Evaluations
          ...
          <div class="tooltip-box">
            ...
            <div class="tt-what">Shows how the factual accuracy of agent answers changes across evaluation runs. A downward trend means something in the pipeline is degrading.</div>
          </div>
        </div>
      </div>
...
<div class="page" id="page-guide">
  ...
  <div class="explain-grid">
    <div class="explain-card" style="--accent:var(--green); border-color:var(--border);">
      ...
      <div class="ec-desc"><b>What it measures:</b> Evaluates whether the agent's answer matches the factuality and details of the reference (expected) answer.<br><br><b>Why use it:</b> Best for offline dataset evaluation (where you have a predefined ground-truth target answer).</div>
      <div class="ec-example">💡 Example: If we expect J&J to be founded in 1886 and the agent says 1990, that's low correctness.</div>
      <div class="ec-scale">
    ...
    <div class="explain-card" style="--accent:var(--blue); border-color:var(--border);">
      ...
      <div class="ec-desc"><b>What it measures:</b> Evaluates whether the agent's response is solely supported by the retrieved context (documents retrieved from RAG), or if it contains hallucinated facts not present in the source materials.<br><br><b>Why use it:</b> Crucial for detecting if the agent is making up claims that aren't in the database.</div>
      <div class="ec-example">💡 Example: If the retrieved docs say "J&J was founded by three brothers" but the agent says "J&J was founded by Pfizer" — that's a faithfulness violation.</div>
      <div class="ec-scale">
    ...
    <div class="explain-card" style="--accent:var(--yellow); border-color:var(--border);">
      ...
      <div class="ec-example">💡 Example: User asks "What is the Innovative Medicine segment?" but the system retrieves documents about MedTech surgical tools.</div>
      <div class="ec-scale">
    ...
    <div class="explain-card" style="--accent:var(--cyan); border-color:var(--border);">
      ...
      <div class="ec-desc">Uses AI vector embeddings to compare the meaning of two texts. Unlike exact word matching, it understands that "oncology drugs treat cancer" and "cancer therapies are part of innovative medicine" mean the same thing.<br><br>Score: 0 = completely different meaning, 1 = identical meaning.</div>
      <div class="ec-example">💡 Example: Generated answer says "Our Credo outlines J&J's values." Expected says "The Credo details our corporate values and responsibilities." → High similarity ≈ 0.9.</div>
      <div class="ec-scale">
    ...
    <div class="explain-card" style="--accent:var(--blue); border-color:var(--border);">
      ...
      <div class="ec-desc">Simply the number of characters in the agent's reply. While not a quality metric by itself, sudden changes are a useful signal.<br><br>A sudden drop may mean the model is being cut off by token limits. A sudden spike could mean runaway generation.</div>
